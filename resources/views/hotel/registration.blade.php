					...
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								...
								<li class="has-dropdown"> <a href="tours.html">Tours</a>
									<ul class="dropdown">
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<p>
							...
							</span> <span class="block">Demo Images: <a href="http://unsplash.co/" target="_blank">Unsplash</a> , <a href="http://pexels.com/" target="_blank">Pexels.com</a></span> </p>
					</div>
				</div>
			</div>
		</footer>
